...
function San_Diego() {
  ...
  const bridgeSegmentLength = 210; // Adjust based on your model
  ...
  const loadBridge = (zPosition) => {
    ...
    loader.load('/San_Deigo.glb', (gltf) => {
...
// const loadSky = (zPosition) => {
//     const loader = new GLTFLoader();
//     loader.load('/sky.glb', (gltf) => {
//       const sky = gltf.scene;
//       sky.position.set(0, 0, zPosition);
//       scene.add(sky);
//       bridgeSegments.push(sky);
//     }, undefined, (error) => console.error(error));
//   };
  ...
  const init = () => {
    ...
    const light1 = new THREE.DirectionalLight(0xffffff, 9);
